...
config.DATASET.NAME='market1501'
config.DATASET.TRANSFORM_LIST =['resize']
# training data augmentation
config.DATASET.FLIP = True
config.DATASET.SCALE_FACTOR = 0.25
config.DATASET.ROT_FACTOR = 30
config.DATASET.IMAGE_SIZE=[128,64]
config.DATASET.RESIZED_IMAGE_SIZE=[384,288]
config.DATASET.IMG_MEAN=[0.486,0.459,0.408]
config.DATASET.IMG_STD=[0.229,0.224,0.225]
# train
config.TRAIN = edict()
